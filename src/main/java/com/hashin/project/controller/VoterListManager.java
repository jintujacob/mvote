...
public class VoterListManager
{
    ...
    public @ResponseBody FormListBean searchVoter(@RequestBody VotersUserBean voterform )
    {
	logger.debug(">>__________________recieved query params:"+ voterform.getVotersId() +" , " 
		+ voterform.getConstituency() +" , "+ voterform.getName()+ " , "+ voterform.getLockOutFlag() );
